...
namespace UnityDonationAlerts
{
    ...
    public class AccessTokenRefresher
    {
        ...
        public void RefreshAccessToken (string refreshToken)
        {
            ...
            refreshRequest.SetRequestHeader("Content-Type", DonationAlertsSettings.RequestContentType);
        ...
        private static bool CheckRequestErrors (UnityWebRequest request)
        {
            if (request == null)
            {
                Debug.LogError("UnityDonationAlerts: Refresh token request failed. Request object is null.");
                return true;
            }
            ...
            if (isError) Debug.LogError("UnityDonationAlerts: Refresh token code request failed." + errorDescription);
            return isError;
        }
    }
}
