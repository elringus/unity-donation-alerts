...
namespace UnityDonationAlerts
{
    ...
    public class AuthCodeExchanger
    {
        ...
        public AuthCodeExchanger (DonationAlertsSettings donationAlertsSettings, IClientCredentials clientCredentials)
        {
        ...
        public void ExchangeAuthCode (string authorizationCode, string codeVerifier, string redirectUri)
        {
            ...
            exchangeRequest.SetRequestHeader("Content-Type", DonationAlertsSettings.RequestContentType);
        ...
        private static bool CheckRequestErrors (UnityWebRequest request)
        {
            if (request == null)
            {
                Debug.LogError("UnityDonationAlerts: Exchange auth code request failed. Request object is null.");
                return true;
            }
            ...
            if (isError) Debug.LogError("UnityDonationAlerts: Exchange auth code request failed." + errorDescription);
            return isError;
        }
    }
}
